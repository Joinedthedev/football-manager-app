        ...
        <div style={{padding:"20px", zIndex:"1"}}>
          ...
          <div style={{display:"flex", justifyContent:"space-between", gap:"40px"}}>
            ...
            <div className={styles.playerColumn}>
              ...
              <img style={{width:"16px", height:'16px'}} src={foundPlayer?.flagImage} />
                <p  className={styles.playerSubtitlesBold}>{foundPlayer?.nationality}</p>
              </p>
            </div>
          </div>
          <div
          ...
          <div className={styles.playerCardBottom}>
            <div style={{display:"flex", alignItems:"center", gap:"50px"}}>
              <div className={styles.playerColumn}>
                <p className={styles.playerGrandTitle}>{foundPlayer?.appearances}</p>
                <p className={styles.playerSubtitles}> Appearances</p>
              </div>
              <div className={styles.playerColumn}>
                <p className={styles.playerGrandTitle}>{foundPlayer?.minutesPlayed}</p>
                <p className={styles.playerSubtitles}> Minutes Played</p>
              </div>
            </div>
            <div style={{display:"flex", alignItems:"center", gap:"50px"}}>
              <div className={styles.playerColumn}>
                <p className={styles.playerGrandTitle}>{foundPlayer?.position === "Goalkeeper"? foundPlayer?.cleanSheets: foundPlayer?.goals}</p>
                <p className={styles.playerSubtitles}> {foundPlayer?.position === "Goalkeeper"? "Clean Sheets": "Goals"}</p>
              </div>
              <div className={styles.playerColumn}>
                <p className={styles.playerGrandTitle}>{foundPlayer?.position === "Goalkeeper"? foundPlayer?.saves: foundPlayer?.assists}</p>
                <p className={styles.playerSubtitles}> {foundPlayer?.position === "Goalkeeper"? "Saves": "Assists"}</p>
              </div>
            </div>
          </div>
