  ...
  return (
    <div className={styles.rosterContainer}>
      <div className={styles.rosterTop}>
        ...
        <div className={styles.rosterTopRight}>
          <input
            ...
            type="text"
          />
          <button onClick = {handleOpenImportTeamModal}className={styles.rosterButton}> Import Team</button>
        </div>
      </div>
      ...
      {importTeamModalIsOpen && (
        <ImportTeamModal open={importTeamModalIsOpen} onClose={handleCloseImportTeamModal} />
      )}
    </div>
  );
};
